...
import com.lsk.gmall.realtime.app.func.DimAsyncFunction;
import com.lsk.gmall.realtime.bean.OrderWide;
import com.lsk.gmall.realtime.bean.PaymentWide;
import com.lsk.gmall.realtime.bean.ProductStats;
import com.lsk.gmall.realtime.bean.VisitorStats;
import com.lsk.gmall.realtime.common.GmallConstant;
import com.lsk.gmall.realtime.utils.ClickHouseUtil;
import com.lsk.gmall.realtime.utils.DateTimeUtil;
...
public class ProductStatsApp {
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        //TODO 5.分组、开窗、聚合
        SingleOutputStreamOperator<ProductStats> productStatsDstream = productStatsWithTsStream.keyBy(
                //5.1 按照商品 id 进行分组
        ...
        //TODO 6.补充商品维度信息
        //6.1 补充 SKU 维度
        SingleOutputStreamOperator<ProductStats> productStatsWithSkuDstream = AsyncDataStream.unorderedWait(productStatsDstream,
